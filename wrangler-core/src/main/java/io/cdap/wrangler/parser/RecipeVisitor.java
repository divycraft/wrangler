...
public final class RecipeVisitor extends DirectivesBaseVisitor<RecipeSymbol.Builder> {
  ...
  // @Override
  // public RecipeSymbol.Builder
  // visitByteSizeValue(DirectivesParser.ByteSizeValueContext ctx) {
  ...
  // @Override
  // public RecipeSymbol.Builder
  // visitTimeDurationValue(DirectivesParser.TimeDurationValueContext ctx) {
  // RecipeSymbol.Builder builder = RecipeSymbol.builder();
  // builder.createTokenGroup(new SourceInfo(
  // ctx.getStart().getLine(),
  // ctx.getStart().getCharPositionInLine(),
  ...
  public RecipeSymbol.Builder visitByteSizeValue(DirectivesParser.ByteSizeValueContext ctx) {
    this.builder.addToken(new Text(ctx.getText()));
    return this.builder;
  }
